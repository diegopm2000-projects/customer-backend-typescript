...
import { IUpdateCustomerRequest, IUpdateCustomerUseCase } from '../modules/main/customer/application/usecases/UpdateCustomer/IUpdateCustomer.usecase'
...
export async function init(): Promise<void> {
  ...
  // const UPDATE_CUSTOMER_PROPS: CustomerProps = {
  //   id: ID.create('08bda2ee-c704-42ab-bf26-ad535847fc5f'),
  //   firstName: 'Malcolm',
  //   lastName: 'X',
  //   email: DEFAULT_EMAIL,
  ...
  // const customerUpdateRequest: IUpdateCustomerRequest = UPDATE_CUSTOMER_PROPS

  // await myApp.container.get<IUpdateCustomerUseCase>(TYPES.IUpdateCustomerUseCase).execute(customerUpdateRequest)
